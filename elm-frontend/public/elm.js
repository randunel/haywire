...
var $author$project$Main$handleCommand = F3(
	function (command, message, model) {
		...
		switch (_v0.$) {
			...
			case 'Molotov_detonate':
				var _v33 = $author$project$Main$decodeOriginatorEntity(message);
				if (_v33.$ === 'Just') {
					var _v34 = _v33.a;
			...
			case 'Player_death':
				var _v37 = $author$project$Main$decodeVictimAttacker(message);
				if (_v37.$ === 'Just') {
					var _v38 = _v37.a;
					var victim = _v38.a;
					var attacker = _v38.b;
			...
			case 'Smokegrenade_detonate':
				var _v45 = $author$project$Main$decodeOriginatorEntity(message);
				if (_v45.$ === 'Just') {
					var _v46 = _v45.a;
