...
var $author$project$Main$keyPressDecoder = F2(
	function (keyPressMotion, model) {
		return A3(
			...
			$elm$json$Json$Decode$succeed(
				$author$project$Main$OnKeyPress(keyPressMotion)));
	});
...
var $author$project$Main$Item_remove = {$: 'Item_remove'};
...
var $author$project$Main$Player_falldamage = {$: 'Player_falldamage'};
...
var $author$project$Main$Round_poststart = {$: 'Round_poststart'};
...
var $author$project$Main$UpdateMap = {$: 'UpdateMap'};
var $author$project$Main$Weapon_fire = {$: 'Weapon_fire'};
...
var $author$project$Main$commandFromString = function (str) {
	switch (str) {
		case 'map':
			return $author$project$Main$UpdateMap;
		case 'bullet_impact':
		...
		case 'grenade_thrown':
			return $author$project$Main$Grenade_thrown;
		...
		case 'item_pickup':
			return $author$project$Main$Item_pickup;
		case 'item_purchase':
			return $author$project$Main$Item_purchase;
		case 'item_remove':
			return $author$project$Main$Item_remove;
		...
		case 'player_falldamage':
			return $author$project$Main$Player_falldamage;
		...
		case 'weapon_fire':
			return $author$project$Main$Weapon_fire;
		case 'weapon_reload':
	...
	var _v0 = $elm$json$Json$Decode$decodeString(
		$author$project$Main$originatorTeamDecoder(
			_List_fromArray(
				['originator'])))(message);
	if (_v0.$ === 'Ok') {
		var playerDetails = _v0.a;
		var _v1 = $elm$json$Json$Decode$decodeString(
...
var $author$project$Main$handleEntity = F2(
	function (entity, model) {
		return _Utils_update(
			model,
			{
				entities: A3($elm$core$Dict$insert, entity.id, entity, model.entities)
			});
	});
...
var $author$project$Main$findOrCreatePlayer = F2(
	function (clientId, players) {
		var _v0 = A2($elm$core$Dict$get, clientId, players);
		if (_v0.$ === 'Just') {
			var player = _v0.a;
			return player;
		} else {
...
var $author$project$Main$handleCommand = F3(
	function (command, message, model) {
		var _v0 = $author$project$Main$commandFromString(command);
		switch (_v0.$) {
			case 'UpdateMap':
				var _v1 = $author$project$Main$decodeMap(message);
				if (_v1.$ === 'Just') {
					var map = _v1.a;
					return A2($author$project$Main$updateMap, map, model);
				} else {
					return A2($author$project$Main$appendLog, message, model);
				}
			case 'Bomb_abortdefuse':
				var _v2 = $author$project$Main$decodeOriginator(message);
				if (_v2.$ === 'Just') {
					var playerDetails = _v2.a;
					return A3(
			...
			case 'Bomb_abortplant':
				var _v3 = $author$project$Main$decodeOriginator(message);
				if (_v3.$ === 'Just') {
					var playerDetails = _v3.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$UnknownAliveState,
			...
			case 'Bomb_begindefuse':
				var _v4 = $author$project$Main$decodeOriginator(message);
				if (_v4.$ === 'Just') {
					var playerDetails = _v4.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
			...
			case 'Bomb_beginplant':
				var _v5 = $author$project$Main$decodeOriginator(message);
				if (_v5.$ === 'Just') {
					var playerDetails = _v5.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$Alive,
			...
			case 'Bomb_dropped':
				var _v6 = $author$project$Main$decodeOriginator(message);
				if (_v6.$ === 'Just') {
					var playerDetails = _v6.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$UnknownAliveState,
			...
			case 'Bomb_exploded':
				return model;
			case 'Bomb_pickup':
				var _v7 = $author$project$Main$decodeOriginator(message);
				if (_v7.$ === 'Just') {
					var playerDetails = _v7.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$Alive,
			...
			case 'Bomb_planted':
				var _v8 = $author$project$Main$decodeOriginator(message);
				if (_v8.$ === 'Just') {
					var playerDetails = _v8.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$Alive,
			...
			case 'Bullet_impact':
				var _v9 = $author$project$Main$decodeOriginatorImpact(message);
				if (_v9.$ === 'Just') {
					var _v10 = _v9.a;
					var playerDetails = _v10.a;
					var coordinates = _v10.b;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$Alive,
			...
			case 'Cs_pre_restart':
				return model;
			case 'Decoy_detonate':
				var _v11 = $author$project$Main$decodeOriginatorEntity(message);
				if (_v11.$ === 'Just') {
					var _v12 = _v11.a;
					var playerDetails = _v12.a;
					var entity = _v12.b;
					return A2(
			...
			case 'Decoy_firing':
				var _v13 = $author$project$Main$decodeOriginatorEntity(message);
				if (_v13.$ === 'Just') {
					var _v14 = _v13.a;
					var playerDetails = _v14.a;
					var entity = _v14.b;
					return A2(
						$author$project$Main$handleEntity,
						entity,
			...
			case 'Decoy_started':
				var _v15 = $author$project$Main$decodeOriginatorEntity(message);
				if (_v15.$ === 'Just') {
					var _v16 = _v15.a;
					var playerDetails = _v16.a;
					var entity = _v16.b;
					return A2(
						$author$project$Main$handleEntity,
						entity,
			...
			case 'Enter_bombzone':
				var _v17 = $author$project$Main$decodeOriginator(message);
				if (_v17.$ === 'Just') {
					var playerDetails = _v17.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$Alive,
			...
			case 'Enter_buyzone':
				var _v18 = $author$project$Main$decodeOriginator(message);
				if (_v18.$ === 'Just') {
					var playerDetails = _v18.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$Alive,
			...
			case 'Enter_rescuezone':
				var _v19 = $author$project$Main$decodeOriginator(message);
				if (_v19.$ === 'Just') {
					var playerDetails = _v19.a;
					return A3(
						$author$project$Main$handlePlayer,
						playerDetails,
						$author$project$Main$Alive,
			...
			case 'Flashbang_detonate':
				var _v23 = $author$project$Main$decodeOriginatorEntity(message);
				if (_v23.$ === 'Just') {
					var _v24 = _v23.a;
					var playerDetails = _v24.a;
					var entity = _v24.b;
					return A2(
						$author$project$Main$handleEntity,
						entity,
			...
			case 'Grenade_bounce':
				var _v25 = $author$project$Main$decodeOriginatorEntity(message);
				if (_v25.$ === 'Just') {
					var _v26 = _v25.a;
			...
			case 'Grenade_thrown':
				var _v27 = $author$project$Main$decodeOriginator(message);
				if (_v27.$ === 'Just') {
			...
			case 'Hegrenade_detonate':
				var _v28 = $author$project$Main$decodeOriginatorEntity(message);
				if (_v28.$ === 'Just') {
					var _v29 = _v28.a;
...
var $author$project$Main$handleMessage = F2(
	function (model, message) {
		var _v0 = A2($elm$json$Json$Decode$decodeString, $author$project$Main$commandDecoder, message);
		if (_v0.$ === 'Ok') {
			var command = _v0.a;
...
var $author$project$Main$handleKeyPress = F3(
	function (keyName, keyPressMotion, model) {
		if (keyName === 'Control') {
			if (keyPressMotion.$ === 'KeyDown') {
				return _Utils_update(
					model,
					{enablePlayerNames: true});
			} else {
				return _Utils_update(
					model,
...
var $author$project$Main$handleVisibilityChanged = F2(
	function (visibility, model) {
		if (visibility.$ === 'Visible') {
			...
			return _Utils_update(
				model,
				{enablePlayerAnimations: false, enablePlayerNames: false});
		}
	});
...
var $author$project$Main$updateBulletAnimation = F2(
	function (animationMsg, bullet) {
		var _v0 = A2($mdgriffith$elm_style_animation$Animation$Messenger$update, animationMsg, bullet.style);
		var style = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
		...
		switch (msg.$) {
			...
			case 'Animate':
				...
				var bulletCmds = A2(
					...
					$elm$core$Dict$values(model.bullets));
				var _v2 = $elm$core$List$unzip(bulletCmds);
				var bulletsList = _v2.a;
				var cmds = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$entitiesSvg = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$b(entity.type_)
						]))
				]));
	});
	...
	function (model, player) {
		...
		return A2(
			...
			A2(
				...
				model.enablePlayerNames ? _List_fromArray(
					[
						A2(
						$elm$svg$Svg$text_,
						_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Main$mapSvg(model)
										]))
								])),
							A2(
							$elm$svg$Svg$rect,
